...
ARG BUILD_FROM=ghcr.io/chukysoria/baseimage-ubuntu:v0.3.28-noble@sha256:760e4adcf9a35e365064a533be279a0bc119e94394ff9f5b2943c8f3d8c4b7a5
FROM ${BUILD_FROM} 
...
ARG BUILD_DATE
ARG BUILD_VERSION
ARG BUILD_EXT_RELEASE="10.10.3+ubu2404"
